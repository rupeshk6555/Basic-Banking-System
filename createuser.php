  ...
  <div class="sm:hidden" id="mobile-menu">
    <div class="px-2 pt-2 pb-3 space-y-1">
      ...
      <a href="transactionhistory.php" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Transfer History</a>
        ...
        <h2 class="text-center pt-4 uppercase font-bold" style="color : black;">Create a User</h2>
        <br>
...
<footer class="p-4 bg-gray-400 place-content-center uppercase mt-5" style="text-align: center;">&copy; December 2021 Made by Rupesh kumar <br> GRIP | The Sparks Foundation</footer>
</body>
</html>